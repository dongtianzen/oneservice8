...
/**
 * Provides a 'Navinfo: side menu' block.
 *
 * @Block(
 *   id = "navinfo_sidemenu",
 *   admin_label = @Translation("Navinfo: side menu")
 * )
 */
class NavinfoSidemenuBlock extends BlockBase {
  ...
  public function build() {
    ...
    $output = $NavinfoBlockGenerator->contentSideMenu();
